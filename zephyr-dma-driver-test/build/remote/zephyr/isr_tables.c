...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[156] = {
	...
	{(const void *)0x1010efc4, (ISR)0x1010e261}, /* 37 */
	...
	{(const void *)0x1010f114, (ISR)0x1010e125}, /* 54 */
