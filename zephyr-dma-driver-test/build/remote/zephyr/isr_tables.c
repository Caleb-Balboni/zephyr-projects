...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[156] = {
	...
	{(const void *)0x1010f56c, (ISR)0x1010e783}, /* 37 */
	...
	{(const void *)0x1010f6bc, (ISR)0x1010e647}, /* 54 */
