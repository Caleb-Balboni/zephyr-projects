...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HN_COREDMA_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_OFFSET, 0x10a000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HN_COREDMA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_FRDM_MCXN947_MCXN947_CPU1, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_MCXN947_CPU1, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SOC_PART_NUMBER_MCXN947VDF, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SECOND_CORE_MCUX_ACCESS_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SRAM_BASE_ADDRESS, 0x30050000);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MBOX_NXP_MAILBOX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_FLASH_LOAD_SIZE, 0xf6000);
