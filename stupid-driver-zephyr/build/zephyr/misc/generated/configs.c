...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HELLO_WORLD_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HELLO_WORLD, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HELLO_WORLD_MODULE, 1);
