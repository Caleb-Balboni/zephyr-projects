...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HN_HSUSB, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_HS_USB_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HWINFO_MCUX_SYSCON, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_VID, 0xFFFF);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_DEVICE_PID, 0x4712);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_USB_REQUEST_BUFFER_SIZE, 512);
