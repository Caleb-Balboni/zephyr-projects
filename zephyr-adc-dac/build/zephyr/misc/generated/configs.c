...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DAC_MCUX_LPDAC, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPAMP, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPAMP_INIT_PRIORITY, 50);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_OPAMP_MCUX_OPAMP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_REGULATOR_NXP_VREF, 1);
