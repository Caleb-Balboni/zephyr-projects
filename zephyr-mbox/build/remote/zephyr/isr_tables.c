...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[156] = {
	...
	{(const void *)0x1010ece4, (ISR)0x1010e10d}, /* 37 */
	...
	{(const void *)0x1010ee34, (ISR)0x1010dfd1}, /* 54 */
