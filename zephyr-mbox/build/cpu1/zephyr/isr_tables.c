...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[156] = {
	...
	{(const void *)0x1010ec7c, (ISR)0x1010e0c5}, /* 37 */
	...
	{(const void *)0x1010edcc, (ISR)0x1010df89}, /* 54 */
