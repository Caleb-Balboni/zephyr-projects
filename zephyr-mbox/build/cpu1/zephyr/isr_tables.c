...
const struct _isr_table_entry __sw_isr_table _sw_isr_table[156] = {
	...
	{(const void *)0x1010ec8c, (ISR)0x1010e0d5}, /* 37 */
	...
	{(const void *)0x1010eddc, (ISR)0x1010df99}, /* 54 */
