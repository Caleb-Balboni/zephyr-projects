...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HN_SPI2C_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_TSYS01_SENSOR_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HN_SPI2C, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_SPI2C_MODULE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_TSYS01_SENSOR, 1);
