...
// @return - the status code (zephyr standard)
int8_t fs_cmd_ls(const char* dir_path, struct fs_dirent* entries_buf, size_t max_ent);
...
// @return - the status code (zephyr standard)
int8_t fs_cmd_mkdir(const char* dir_path);
...
// @return - the status code (zephyr standard)
int8_t fs_cmd_touch(const char* file_path, size_t data_size, void* data);
