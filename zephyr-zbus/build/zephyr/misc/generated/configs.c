...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_ASYNC_LISTENER, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_ASYNC_LISTENER_EXEC_TIMEOUT, 200);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZBUS_PRIORITY_BOOST, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HEAP_MEM_POOL_ADD_SIZE_ZBUS, 2048);
