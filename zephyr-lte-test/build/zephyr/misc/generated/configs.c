...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_HN_LTE_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_HN_LTE, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZEPHYR_MCXN_LTE_MODULE, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MFD_LOG_LEVEL, 4);
