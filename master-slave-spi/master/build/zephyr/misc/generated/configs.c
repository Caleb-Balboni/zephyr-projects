...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_MCUX_EDMA_V4, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_MCUX_MAX_DATA_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DMA_MCUX_SMARTDMA, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SPI_NXP_LPSPI_DMA, 1);
